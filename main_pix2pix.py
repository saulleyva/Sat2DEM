...
EXPERIMENT_NAME = "pix2pix_sentinel"
...
if __name__ == "__main__":
    ...
    for split in range(1, 5):
        ...
        metrics = {
            'epoch': [],
            'train_MAE': [], 'train_RMSE': [], 'train_SSIM': [], 'train_R2': [], 'train_G_loss': [], 'train_D_loss': [],
        ...
        for epoch in range(1, NUM_EPOCHS + 1):
            ...
            for dem, sat in train_loader:
                ...
                if USE_GRADIENT_LOSS:
                    ...
                    loss_G = loss_G_GAN + loss_G_L1 + gradient_loss
                else:
            ...
            with torch.no_grad():
                for dem, sat in val_loader:
                    ...
                    if USE_GRADIENT_LOSS:
                        ...
                        loss_G_val = loss_G_GAN_val + loss_G_L1_val + gradient_loss_val
                    else:
